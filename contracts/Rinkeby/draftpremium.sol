...
interface Kyber {
    function getOutputAmount(ERC20 from, ERC20 to, uint256 amount)
        external
        view
        returns (uint256);

    function getInputAmount(ERC20 from, ERC20 to, uint256 amount)
        external
        view
        returns (uint256);
}
...
contract PremiumFeedPrices {
    ...
    function getUniswapContract(address tokenAddress)
        public
        constant
        returns (address)
    {
    ...
    function compare(string _a, string _b) returns (int256) {
    ...
    function indexOf(string _haystack, string _needle) returns (int256) {
